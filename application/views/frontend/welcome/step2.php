<div class="container p-5 animated fadeIn mt-3" style="background: <?= $setting['set_background'] ?>;">
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="row mt-5">
        <div class="col-md-12 text-center">
            <a href="<?= base_url() ?>step-3" class="btn btn-success btn-lg" style="width: 40%; height: 50pt; font-size: 20pt;">LANJUT</a>
        </div>
    </div>
</div>
<script>
