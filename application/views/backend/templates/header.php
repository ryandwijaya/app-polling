...
<body class="light">
	...
	<div class="page-loader-wrapper">
		<div class="loader">
			<div class="m-t-30">
				<img class="loading-img-spin" src="<?= base_url() ?>assets/images/loading.png" width="20" height="20"
					alt="admin">
			</div>
			<p>Please wait...</p>
		</div>
								...
								<ul class="user_dw_menu">
									...
									<li>
										<a href="#" onClick="return false;">
											...
											<?= $this->session->userdata('sess_hr_lyn') ?>
										</a>
									</li>
									<li>
				...
				<ul class="list">
					<li class="sidebar-user-panel active">
						<div class="user-panel">
							<div class=" image">
								<img src="<?= base_url() ?>assets/images/interview.png"
